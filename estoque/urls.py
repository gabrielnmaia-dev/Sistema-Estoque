...
path('produtos/<int:pk>/deletar', views.CategoriaDeleteView.as_view(), name='produto-delete'),
...
path('produtos/<int:pk>/deletar/', views.CategoriaDeleteView.as_view(), name='categoria-delete'),
